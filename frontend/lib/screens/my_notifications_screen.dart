...
class _MyNotificationsScreenState extends State<MyNotificationsScreen> {
  ...
  Future<void> _fetch() async {
    ...
    try {
      final uri = Uri.parse(
        '${widget.baseUrl}/api/notifications/citizen/${Uri.encodeComponent(widget.citizenId)}',
      );
  ...
  Future<void> _markAllRead() async {
    try {
      final uri = Uri.parse(
        '${widget.baseUrl}/api/notifications/citizen/${Uri.encodeComponent(widget.citizenId)}/read-all',
      );
                  ...
                  child: _items.isEmpty
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final matchingId = (n['matching_id'] ?? '')
                                .toString();
                            final requestId = (n['request_id'] ?? '')
                                .toString();
                            final actionable =
                                type == 'TRANSFER' &&
                                matchingId.isNotEmpty &&
                                          ...
                                          children: [
                                            ElevatedButton.icon(
                                              onPressed: () async {
                                                ...
                                                try {
                                                  final uri = Uri.parse(
                                                    '${widget.baseUrl}/api/transfer-requests/match/$matchingId/agree?request_id=${Uri.encodeComponent(requestId)}',
                                                  );
                                                  ...
                                                  if (res.statusCode == 200) {
                                                    ...
                                                    try {
                                                      final readUri = Uri.parse(
                                                        '${widget.baseUrl}/api/notifications/citizen/${Uri.encodeComponent(widget.citizenId)}/read/${Uri.encodeComponent(id)}',
                                                      );
                                                      await http.post(
                                                        readUri,
                                                        headers: {
                                            ...
                                            OutlinedButton.icon(
                                              onPressed: () async {
                                                ...
                                                try {
                                                  final uri = Uri.parse(
                                                    '${widget.baseUrl}/api/transfer-requests/match/$matchingId/disagree?request_id=${Uri.encodeComponent(requestId)}',
                                                  );
                                                  final res = await http.post(
                                                    uri,
                                                    headers: {
                                                  ...
                                                  if (res.statusCode == 200) {
                                                    ...
                                                    if (mounted) {
                                                      ...
                                                      ScaffoldMessenger.of(
                                                        ...
                                                        const SnackBar(
                                                          content: Text(
                                                            'Disagreed. Match reset to pending.',
                                                          ),
                                                        ),
                                                      );
                                                    }
